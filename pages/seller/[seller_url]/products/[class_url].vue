<template>
  <main>
    <div class="container">
      <Catalog :info-api-url="`/seller/${route.params.seller_url}/products/${route.params.class_url}`"
               products-api-url="/get-products/seller-class" :unusual-seo="true" @setSeo="setSeo">
